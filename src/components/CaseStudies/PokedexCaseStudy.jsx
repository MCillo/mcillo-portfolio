...
export const pokedexCaseStudy = () => {
  ...
  return (
    ...
    <div class="body">
      <div class="navbar">
        <a href="src/components/Projects/Projects.jsx">Back to Michael-Cillo.com</a>
      ...
      <div class="container">
        ...
        <div class="overviewContainer">
          ...
          <img src="/assets/projects/Pokedex-App.png" alt="Image of Pokedex App" class="pokedexAppImg" />
        </div>
        <div class="approach">
          <h3>Approach</h3>
          <div class="javaScriptContainer">
            ...
            <img src="/assets/projects/Pokedex-JavaScript.png" alt="Image of Pokedex App JavaScript Code"
              class="pokedexJavaScriptImg" />
          </div>
          <div class="htmlContainer">
            <img src="/assets/projects/Pokedex-HTML.png" alt="Image of Pokedex App HTML Code" class="pokedexHTMLImg" />
            <div class="html">
              <h5>HTML</h5>
          ...
          <div class="cssContainer">
            ...
            <img src="/assets/projects/Pokedex-CSS.png" alt="Image of Pokedex App CSS Code" class="pokedexCSSImg" />
          </div>
        </div>
        <div class="challengesContainer">

          <img src="/assets/projects/Pokedex-Modal.png" alt="Image of Pokedex Modal" class="pokedexModalImg" />
